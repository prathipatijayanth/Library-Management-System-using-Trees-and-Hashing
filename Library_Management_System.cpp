...
void viewComplaints()
{
    ...
    {
        cout << endl << dup_complaints_queue.front()<< "    ";
...
int main()
{
        ...
        case 1 :
            ...
            if (admins.find(id) != admins.end() && admins[id] == apass)
            {
                ...
                while (sc!=6)
                {
                    ...
                    cout << "4. view complaints/issus" << endl;
                    ...
                    case 4:
                        viewComplaints();
                        if(!complaints_queue.empty()){
                            cout<<"Would you like to resolve the issue?"<<endl;
                    ...
                    case 5:
                        ...
                        else if(c6==2)
                        {
                            ...
                            if(userinfo[id6]->ostat){
                                ...
                                cout << "seat dealloated successfully for student-ID "<<id6<<endl;
                                seats++;
                                cout << "Remaining seats are "<<seats<<endl;
                            }
                            else{
            ...
            if (users.find(uid) != users.end() && users[uid] == upass)
            {
                ...
                while(sc!=8)
                {
                    ...
                    case 5 :
                        ...
                        {
                            cout<< "You didnt raise any issues as of now." <<endl;
                            break;
                        }
                        ...
                        cout<<"Yur issue is resolved, and feedback recieved is - "<<userinfo[uid]->cstat<<endl;
                        break;
                    case 6:
                        rating(uid);
                        break;
    ...
    cout << "exited from applicatio successfully !"<<endl;
    system("cls");
    cout<<"Savng changes ...."<<endl;
    Sleep(3000);
